-- Add Restaurants table (idempotent)
...
IF NOT EXISTS (SELECT 1 FROM Restaurants WHERE RestaurantId = 'REST-0001')
BEGIN
    ...
    PRINT '8 restaurants inserted successfully';
END
ELSE
BEGIN
    PRINT 'Restaurants already exist - skipping insert';
END
